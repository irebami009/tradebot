    ...
    return (
      <div className="card">
        ...
        <div style={{ padding: '40px', textAlign: 'center', color: 'var(--text-secondary)' }}>
          No backtest performance curve available yet. Click "Run Backtest" to generate curve.
        </div>
      </div>
    );
  }
      ...
      <div className="chart-container">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 10, right: 20, left: 0, bottom: 0 }}>
            ...
            />
            <Area type="monotone" dataKey="balance" stroke="#2563eb" strokeWidth={2} fillOpacity={1} fill="url(#equityGrad)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
    </div>
